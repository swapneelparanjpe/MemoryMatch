...
import com.swappy.apps.memorymatch.utils.BitmapScalar
import com.swappy.apps.memorymatch.utils.EXTRA_BOARD_SIZE
import com.swappy.apps.memorymatch.utils.EXTRA_GAME_NAME
import com.swappy.apps.memorymatch.utils.isPermissionGranted
import com.swappy.apps.memorymatch.utils.requestPermission
    ...
    private fun handleAllImagesUploaded(gameName: String, imageUrls: MutableList<String>) {
        db.collection("games").document(gameName)
            ...
            .addOnCompleteListener { gameCreationTask ->
                ...
                AlertDialog.Builder(this)
                    .setTitle("Upload complete! Let's play our game '$gameName'")
